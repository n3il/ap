...
export default function TradeHistoryTable({ userId, agentId }) {
  ...
  if (loading) {
    return (
      <View sx={{ flex: 1, justifyContent: 'center', alignItems: 'center', paddingVertical: 8 }}>
      ...
      >
        ...
        >
          <View style={styles.headerRow}>
            ...
            <View style={{ width: COLUMN_WIDTHS.price, paddingHorizontal: 8, alignItems: 'flex-end' }}>
              <Text variant="xs" tone="muted">
                Price/Avg Price
              </Text>
            </View>
            <View style={{ width: COLUMN_WIDTHS.time, paddingHorizontal: 8, alignItems: 'flex-end' }}>
              <Text variant="xs" tone="muted">
                Time
              </Text>
            </View>
            ...
            >
              <View style={styles.dataRow}>
                ...
                <View style={{ width: COLUMN_WIDTHS.status, paddingHorizontal: 8, justifyContent: 'center' }}>
                  ...
                  >
                    {trade.side === 'LONG' ? 'Buy' : trade.side === 'SHORT' ? 'Sell' : trade.status || '--'}
                  </Text>
                </View>
                ...
                >
                  ...
                  {trade.avg_price && trade.entry_price && trade.avg_price !== trade.entry_price && (
                    <Text variant="xs" tone="muted">
                      {parseFloat(trade.avg_price).toFixed(2)}
                    </Text>
                  )}
