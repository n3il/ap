...
import { View, Text, TouchableOpacity, StatusBadge } from '@/components/ui';
    ...
    >
      ...
      <View sx={{ flexDirection: 'row', justifyContent: 'space-around', marginTop: 3 }}>
        <View sx={{ alignItems: 'center' }}>
          ...
          <Text sx={{ fontSize: 12, color: '#FFFFFF', marginTop: 1 }}>Trade</Text>
        </View>

        <View sx={{ alignItems: 'center' }}>
          <MaterialCommunityIcons name="plus" size={24} color="#FFFFFF" />
          <Text sx={{ fontSize: 12, color: '#FFFFFF', marginTop: 1 }}>Deposit</Text>
        </View>

        <View sx={{ alignItems: 'center' }}>
          <MaterialCommunityIcons name="file-document-outline" size={24} color="#FFFFFF" />
          <Text sx={{ fontSize: 12, color: '#FFFFFF', marginTop: 1 }}>Details</Text>
        </View>
      </View>
      ...
      <View sx={{ position: 'absolute', top: 24, right: 24 }}>
        ...
        >
          <Text sx={{ fontSize: 10, fontWeight: '600', color: '#FFFFFF', textTransform: 'uppercase' }}>
